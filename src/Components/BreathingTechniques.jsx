    ...
    <Card className={classes.container}>
      <Card.Body>
        ...
        {isRunning ? (
          ...
          <>
            <Typography variant="body1" className={classes.exerciseStep}>
            ...
            <Button variant="primary" onClick={() => startExercise(5)} className={classes.buttonContainer}>
              Start
            </Button>
          </>
        )}
...
//             Repeat for 5 minutes.
//           </Typography>
//           <Button variant="contained" onClick={() => startExercise(5)} className={classes.buttonContainer}>
//             Start
//           </Button>
//         </>
//       )}
...
//   return (
//     <div>
//       <Typography variant="h4">Breathing Techniques</Typography>
//       {isRunning ? (
//         <Grid container spacing={2} alignItems="center">
//           <Grid item xs={12} sm={6}>
...
//           <Typography variant="body1">Take a deep breath in through your nose for 4 seconds.</Typography>
//           <Typography variant="body1">Hold your breath for 4 seconds.</Typography>
//           <Typography variant="body1">Exhale slowly through your mouth for 6 seconds.</Typography>
//           <Typography variant="body1">Repeat for 5 minutes.</Typography>
//           <Button variant="contained" onClick={() => startExercise(5)}>
//             Start
//           </Button>
//         </>
//       )}
